...
merge (Branch r l i) (Leaf c n) = (Branch (Branch r l i) (Leaf c n) (i+n))
merge (Leaf c n) (Branch r l i) = (Branch (Leaf c n) (Branch r l i) (n+i))
merge (Branch r l i) (Branch r' l' i') = (Branch (Branch r l i) (Branch r' l' i') (i+i'))
-- Question:
