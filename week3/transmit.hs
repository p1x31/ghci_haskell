-- Binary string transmitter example from chapter 7 of Programming -- in Haskell, Graham Hutton, Cambridge University Press, 2016.
import Data.Char -- Base conversion type Bit = Int bin2int :: [Bit] -> Int
